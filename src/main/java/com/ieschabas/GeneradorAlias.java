...
class GeneradorAlias {
    ...
    /**
     * Método para construir el nombre completo y el ciclo
     *
    ...
    /**
     * Método para generar alias: primeras 3 letras del nombre + últimas 3 letras del ciclo
     *
     * @return String
     */
    ...
    /**
     * Método para generar código numérico: suma de los códigos ASCII de las iniciales del nombre y ciclo
     *
     * @return int
     */
